...
public static class WaveStreamExtensions
{
    ...
    private static void SetPosition(this WaveStream waveStream, long position)
    {
        // distance from block boundary (it may be 0)
    ...
    // Set playback position of WaveStream by seconds
    private static void SetPosition(this WaveStream waveStream, double seconds) =>
